...
public class SavingsAccount extends Account
{
	...
	{
		return "Savings Account Details : Account Id"+this.getAccountId()+"Customer Id:"+this.getCustomerId()+"Bank:"+this.getBank()+"AccountType:"+this.getAccountType()+"balance:"+this.getBalance()+"interest rate:"+this.getInterestRate();                                                                      
	}
}
