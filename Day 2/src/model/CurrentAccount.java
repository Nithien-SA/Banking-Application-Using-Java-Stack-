...
public class CurrentAccount extends Account
{
	...
	{
		return "Current Account Details : Account Id"+this.getAccountId()+"Customer Id:"+this.getCustomerId()+"Bank:"+this.getBank()+"AccountType:"+this.getAccountType()+"balance:"+this.getBalance()+"overdraftLimit:"+this.getOverdraftLimit();                                                                      
	}
}
